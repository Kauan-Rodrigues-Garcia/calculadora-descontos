...
import { Copy, Calculator, Settings, Moon, Sun, HelpCircle, User, ExternalLink } from "lucide-react";
...
const Index = () => {
  ...
  // Configuração dos descontos por setor - V19 ATUALIZADA
  ...
  const calcularTodosDescontos = () => {
    ...
    if (descontosSetor.juncao > 0 && podeExibirJuncao) {
      if (setor === "EM DIA") {
        // Para EM DIA: 2 parcelas (novembro + dezembro)
        ...
        // Para outros setores: parcelas em atraso + 1 a vencer
        ...
        mensagemGerada += `*${numeroOpcao} - Junção* (${parcelasAtrasoNum} parcelas em atraso + 1 a vencer) de *R$ ${valorTotalJuncao.toFixed(2).replace('.', ',')}* por *R$ ${valorComDesconto.toFixed(2).replace('.', ',')}* Vencimento: *HOJE*\n\n`;
      }
      numeroOpcao++;
    }
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <Tabs defaultValue="calculadora" className="w-full">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="ajuda">Como Usar</TabsTrigger>
          </TabsList>
              ...
              <Card className={isDark ? 'bg-slate-800 border-slate-600' : 'bg-white'}>
                ...
                <CardContent className="space-y-6">
                  <div className={`p-4 rounded-lg ${
                    isDark ? 'bg-slate-700 border border-slate-600' : 'bg-blue-50 border border-blue-200'
                  }`}>
                    ...
                    <p className={`text-sm leading-relaxed ${
                      ...
                      Esta calculadora foi desenvolvida para <strong>otimizar negociações</strong> e <strong>aumentar conversões</strong> em cobranças. 
                      Ela automatiza o cálculo de descontos por setor e gera mensagens padronizadas para WhatsApp, 
                      garantindo <strong>agilidade</strong>, <strong>precisão</strong> e <strong>profissionalismo</strong> no atendimento.
                    </p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className={`p-4 rounded-lg border ${
                      ...
                      <ol className={`text-sm space-y-2 ${
                        ...
                        <li><strong>1.</strong> Selecione o setor do cliente</li>
                        <li><strong>2.</strong> Informe o valor total em aberto</li>
                        <li><strong>3.</strong> Digite o valor da parcela atual</li>
                        <li><strong>4.</strong> Informe parcelas em atraso (se houver)</li>
                        <li><strong>5.</strong> Clique em "Gerar Todas as Opções"</li>
                        <li><strong>6.</strong> Copie a mensagem gerada</li>
                      </ol>
                    </div>
                    ...
                    <div className={`p-4 rounded-lg border ${
                      ...
                      <ul className={`text-sm space-y-2 ${
                        ...
                        <li>• <strong>Junção:</strong> Máximo 2 parcelas em atraso</li>
                        <li>• <strong>Semestral:</strong> Mínimo 6 parcelas totais</li>
                        <li>• <strong>Anual:</strong> Mínimo 12 parcelas totais</li>
                        <li>• <strong>Todas em atraso:</strong> Remove semestral/anual</li>
                      </ul>
                    </div>
                  </div>

                  <div className={`p-4 rounded-lg border ${
                    isDark ? 'bg-slate-700 border-slate-600' : 'bg-yellow-50 border-yellow-200'
                  }`}>
                    <h4 className={`font-semibold mb-2 flex items-center gap-2 ${
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                      <div className={isDark ? 'text-slate-300' : 'text-gray-600'}>
                        <strong>EM DIA:</strong> 5-20%
                      </div>
                      <div className={isDark ? 'text-slate-300' : 'text-gray-600'}>
                        <strong>PLAY 1:</strong> 8-25%
                      </div>
                      <div className={isDark ? 'text-slate-300' : 'text-gray-600'}>
                        <strong>PLAY 2:</strong> 20-35%
                      </div>
                      <div className={isDark ? 'text-slate-300' : 'text-gray-600'}>
                        <strong>PLAY 3+:</strong> 12-60%
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className={isDark ? 'bg-slate-800 border-slate-600' : 'bg-white'}>
                ...
                <CardContent>
                  <div className={`p-8 rounded-xl text-center ${
                    isDark ? 'bg-gradient-to-br from-slate-700 to-slate-600' : 'bg-gradient-to-br from-purple-50 to-indigo-100'
                  }`}>
                    {/* Foto da equipe Elites - tamanho grande e proporcional */}
                    <div className="w-64 h-40 rounded-2xl mx-auto mb-6 overflow-hidden border-4 border-white shadow-2xl">
                      <img 
